...
public class gestion_emprunts {
	public gestion_emprunts() {
		...
		cols.add("id abonné");
    	cols.add("num exemplaire");
    	cols.add("Date emprunt");
    	cols.add("Date retour");
        JFrame f = new JFrame("Gestion emprunts");
        f.setLayout(new FlowLayout());
        String[][] data= data_fromarraylist(new Admin().getListAdmin());
        gestion_entite p1=new gestion_entite("Emprunts",cols,data);///external action listener
